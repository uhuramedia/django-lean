...
from django_lean.experiments.models import (Experiment, Participant, GoalRecord,
                                            GoalType, AnonymousVisitor, DailyConversionReport)
...
admin.site.register(DailyConversionReport)
